...
| `06` mnemonic / derivation | mnemonic validate, seed derivation, canonical key derivation, zeroization, typed errors | wallet UX, account selection, secret storage, import/export flows | wallet/account manager over kernel derivation helpers | current split is correct; full NFKD and bounded BIP-85 derivation remain future kernel follow-ups |
