...
[api-reference.md](/workspace/projects/noztr/docs/reference/api-reference.md).
...
- strict event, filter, message, transcript, and checked-wrapper flow
  - guide entry: [core-api-contracts.md](/workspace/projects/noztr/docs/reference/core-api-contracts.md)
...
- NIP-05 identity parsing and bunker discovery
  - route: [contract-map.md](/workspace/projects/noztr/docs/reference/contract-map.md)
...
- NIP-06 mnemonics, `nostr_keys`, and bounded BIP-85 helpers
  - route: [api-reference.md](/workspace/projects/noztr/docs/reference/api-reference.md)
...
- media metadata, listings, Blossom helpers, code snippets, chess PGN
  - references: [api-reference.md](/workspace/projects/noztr/docs/reference/api-reference.md), [nip-coverage.md](/workspace/projects/noztr/docs/reference/nip-coverage.md)
