...
| Wallet Connect envelope and JSON helpers | `uri_parse`, `uri_serialize`, `request_extract`, `response_extract`, `notification_extract`, `request_parse_json`, `response_parse_json` | `nip47_example.zig` | `wallet_connect_adversarial_example.zig` |
