...
- Implemented NIPs from `src/root.zig` exports:
  ...
  - `NIP-56`, `NIP-58`, `NIP-59`, `NIP-65`, `NIP-70`, `NIP-73`, `NIP-84`
  - Optional I6 extension exports (build-flag gated): `NIP-45`, `NIP-50`, `NIP-77`
- Current prep focus: the kernel-first sequence is complete; next recommended focus is a targeted
  robustness batch before split-later work or `nzdk` (`docs/plans/phase-h-kickoff.md`).
